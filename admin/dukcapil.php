                ...
                <div class="container-fluid px-8">
                    ...
                    <div class="row">
                        <div class="ms-4 col-sm-10 col-md-11">
                            <h4 class="ms-3"><i class="fa fa-cubes"></i> Data Pinjam Pakai Dukcapil Pusat</h4>
                            <hr class="mt-3">
                        </div>
                        ...
                        <div class="ms-4 col-sm-10 col-md-2">
                            <button type="button" class="btn btn-primary py-1" data-bs-toggle="modal" data-bs-target="#ModalTambahDukcapil"> Tambah Data </button>
                        </div>
                                    ...
                                    <div class="ms-4 col-md-11 mt-3">
                                        <table id="tables" class="table table-hover table-sm">
                                            ...
                                            <tbody>
                                                ...
                                                <?php
                                                $no = 1;
                                                $tampil = mysqli_query($koneksi, "Select * From pinjam_pakai_dukcapil_pusat ORDER BY kode_site ASC");
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="#" class="btn btn-warning py-1" data-bs-toggle="modal" data-bs-target="#ModalUbahDukcapil<?= $id_pinjam ?>"><i class="fa-solid fa-pen-to-square"></i></a>
                                                            <a href="#" class="btn btn-danger py-1" data-bs-toggle="modal" data-bs-target="#ModalHapusDukcapil<?= $id_pinjam ?>"><i class="fa-solid fa-trash-can"></i></a>
                                                        </td>
                                                    </tr>
                                                    <!-- Awal Modal Ubah Data -->

                                                    <div class="modal fade" id="ModalUbahDukcapil<?= $id_pinjam ?>" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                    <h1 class="modal-title fs-5" id="staticBackdropLabel">Ubah Data Pinjam Pakai Dukcapil Pusat</h1>
                                                                ...
                                                                <form method="POST" action="../function.php">
                                                                    ...
                                                                    <div class="modal-body">
                                                                        <div class="mb-3">
                                                                            ...
                                                                            <input type="text" class="form-control" name="kode_site" value="<?= $data['kode_site'] ?>" id="kode_siteb-<?= $data['id_pinjam'] ?>" readonly>
                                                                        </div>

                                                                        <div class="mb-3">
                                                                            <label class="form-label">Wilayah</label>
                                                                            <select name="wilayah" id="wilayah" class="form-select" onchange='changeValues("<?= $id_pinjam; ?>", this.value)' required>
                                                                                ...
                                                                                while ($row = mysqli_fetch_array($result)) {
                                                                                    echo '<option name="wilayah" data-id="' . addslashes($row['kode_site']) . '" value="' . $row['wilayah'] . '">' . $row['wilayah'] . '</option>';
                                                                        ...
                                                                        <div class="mb-3">
                                                                            ...
                                                                            <?php
                                                                            $options = array("Belum Terkirim", "Belum Aktif", "Sudah Aktif"); // daftar opsi ENUM
                                                                    ...
                                                                    <div class="modal-footer">
                                                                        ...
                                                                        <button type="submit" class="btn btn-success py-1" name="ButtonUbahDukcapil">Ubah</button>
                                                                    </div>
                                                                </form>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <!-- Modal Hapus Data -->
                                                    <div class="modal fade" id="ModalHapusDukcapil<?= $id_pinjam ?>" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                    <h1 class="modal-title fs-5" id="staticBackdropLabel">Hapus Data Pinjam Pakai Dukcapil Pusat</h1>
                                                                ...
                                                                <form method="POST" action="../function.php">
                                                                    ...
                                                                    <div class="modal-footer">
                                                                        <button type="button" class="btn btn-danger py-1" data-bs-dismiss="modal">Batal</button>
                                                                        <button type="submit" class="btn btn-success py-1" name="ButtonHapusDukcapil">Hapus</button>
                                                                    </div>
                                                                </form>
                                                            </div>
                                                        </div>
                                            ...
                                            <!-- Awal Kode Otomatis -->
                                            <?php
                                            $query = mysqli_query($koneksi, "SELECT max(id_pinjam) as angkaTerbesar1 FROM pinjam_pakai_dukcapil_pusat");
                                            $data = mysqli_fetch_array($query);
                                            $idpjm = $data['angkaTerbesar1'];

                                            $urut = (int) substr($idpjm, 3, 3);
                                            $urut++;

                                            $huruf = "PJM";
                                            $idpjm = $huruf . sprintf("%03s", $urut);
                                            ?>
                                            <!-- Akhir Kode Otomatis -->
                                            <!-- Awal Modal Tambah Data -->
                                            <div class="modal fade" id="ModalTambahDukcapil" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h1 class="modal-title fs-5" id="staticBackdropLabel">Form Tambah Data Dukcapil dan APBD</h1>
                                                        ...
                                                        <div class="modal-body">
                                                            <form method="POST" action="../function.php">
                                                                ...
                                                                <input type="text" class="form-control" name="id_pinjam" value="<?php echo $idpjm ?>" hidden readonly>
                                                                ...
                                                                <?php
                                                                $query = "SHOW COLUMNS FROM pinjam_pakai_dukcapil_pusat WHERE Field = 'status'";
                                                        ...
                                                        <div class="modal-footer">
                                                            <button type="button" class="btn btn-danger py-1" data-bs-dismiss="modal">Batal</button>
                                                            <button type="submit" class="btn btn-success py-1" name="ButtonSimpanDukcapil">Simpan</button>
                                                            </form>
                                                        </div>
                                                    </div>
                                                </div>
