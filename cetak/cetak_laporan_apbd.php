...
$pdf->Cell(50);
$pdf->Cell(50,20,'LAPORAN PENGADAAN DAERAH APBD');
$pdf->Ln(4);
...
$sql = mysqli_query($koneksi, "SELECT * FROM pengadaan_daerah_apbd where tanggal BETWEEN '$dari' AND '$sampai' order by id_pengadaan ASC");
$no = 1;
