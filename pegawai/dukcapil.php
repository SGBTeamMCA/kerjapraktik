                                                            ...
                                                            <div class="modal-content">
                                                                ...
                                                                <form method="POST" action="../function.php">
                                                                    ...
                                                                    <div class="modal-footer">
                                                                        ...
                                                                        <button type="submit" class="btn btn-success py-1" name="pegawaiButtonUbahDukcapil">Ubah</button>
                                                                    </div>
                                                                </form>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">
                                                                ...
                                                                <form method="POST" action="../function.php">
                                                                    ...
                                                                    <div class="modal-footer">
                                                                        <button type="button" class="btn btn-danger py-1" data-bs-dismiss="modal">Batal</button>
                                                                        <button type="submit" class="btn btn-success py-1" name="pegawaiButtonHapusDukcapil">Hapus</button>
                                                                    </div>
                                                                </form>
                                                            </div>
                                                        </div>
                                            ...
                                            <div class="modal fade" id="ModalTambahDukcapil" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            <button type="button" class="btn btn-danger py-1" data-bs-dismiss="modal">Batal</button>
                                                            <button type="submit" class="btn btn-success py-1" name="pegawaiButtonSimpanDukcapil">Simpan</button>
                                                            </form>
                                                        </div>
                                                    </div>
                                                </div>
