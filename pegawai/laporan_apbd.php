...
<html lang="en">
    <head>
        ...
        <title>Laporan Pengadaan Daerah APBD</title>
  ...
  <script>
                ...
                <main>
                    <div class="container-fluid px-8">
                        ...
                        <div class="row">
                            ...
                            <h4 class="ms-3"><i class="fa fa-cubes"></i> Laporan Pengadaan Daerah APBD </h4>
                            <hr class="mt-3" >
                            </div>
    ...
    <!-- Awal Menampilkan data dari database ke sebuah table -->                   
                                    ...
                                    if (isset($_POST['filter'])) {
                                        ...
                                        $sql1 = mysqli_query($koneksi, "SELECT * FROM pengadaan_daerah_apbd where tanggal BETWEEN '$dari' AND '$sampai' order by id_pengadaan ASC");
        
                                    } else {
                                        $sql1 = mysqli_query($koneksi, "SELECT * FROM pengadaan_daerah_apbd where tanggal");
                                      }
   ...
   href="..//cetak/cetak_laporan_apbd.php?dari_tgl=<?php echo $dari; ?>&&sampai_tgl=<?php echo $sampai; ?>"
   target="_blank">
   Cetak Laporan</a>  
                            </div>
                         </div>
